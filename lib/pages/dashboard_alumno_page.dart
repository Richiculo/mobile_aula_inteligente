...
class DashboardAlumnoPage extends StatefulWidget {
  const DashboardAlumnoPage({super.key});

  @override
  State<DashboardAlumnoPage> createState() => _DashboardAlumnoPageState();
}

class _DashboardAlumnoPageState extends State<DashboardAlumnoPage> {
  ...
  double calcularPromedioReal(List<Map<String, dynamic>> predicciones) {
  ...
  Widget build(BuildContext context) {
    ...
    final resumen = provider.resumenDashboard;
                          ...
                          DropdownButtonFormField<int>(
                            ...
                            onChanged: (valor) {
                              if (valor != null) {
                                ...
                                provider.cargarResumenDashboard();
                                provider.cargarPrediccionRendimiento(valor);
                              }
                            },
                          ),
                        ],
